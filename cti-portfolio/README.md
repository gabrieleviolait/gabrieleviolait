...
See [Methodology & Analytic Standards](METHODOLOGY.md).

Core workflow:

`Intelligence Requirement → Collection → Validation → Correlation → Analysis → Confidence Assessment → Reporting`
...
This repository is intentionally sanitized. It does **not** publish live onion addresses, private invitations, credentials, research identities, personal data, access-enabling information, or raw material that would unnecessarily expose operational sources.

An extended evidence portfolio can be made available privately to recruiters or hiring managers when appropriate.

## Disclaimer

This portfolio is for legitimate cybersecurity research, threat intelligence and professional demonstration. Monitoring described here is passive and defensive in purpose. References to criminal or hacktivist groups do not imply affiliation, participation or endorsement.

## Contact

- Website: https://www.gabrieleviola.it/
- LinkedIn: https://www.linkedin.com/in/gabriele-viola/
- GitHub: https://github.com/gabrieleviolait
